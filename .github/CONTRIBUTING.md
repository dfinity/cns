...
Thank you for your interest in contributing to the Chain Name System for the Internet Computer.
...
- If you want to report an issue, click [issues](https://github.com/dfinity/cns/issues).
...
1. Click [create a new issue](https://github.com/dfinity/cns/issues/new).
...
2. Navigate to the [repository's homepage](https://github.com/dfinity/cns) in a web browser.
...
8. Commit your changes to store the contents you added to the index along with a descriptive message by running a command similar to the following:
   ```shell
   git commit -m 'my clear change description'
   ```
...
10. Create a new pull request (PR) for the branch you pushed to the upstream GitHub repository.
    - The PR title should use the conventional commits format
      - See [Conventional commits](https://www.conventionalcommits.org/en/v1.0.0/) for more information on the formats.
